    ...
    return (
        <div className="Lab-page max-w-3xl mx-auto text-left py-8 px-4 text-sans text-[#CECECE] ">
            ...
            <p className="mb-4" style={{color : "white"}}>
                In Java, the <span style={{  fontWeight: 'bold'}}> BufferedReader</span> class is a part of the <span style={{  fontWeight: 'bold'}}>java.io</span> package and
                provides efficient of text from character input streams. It extends the <span style={{  fontWeight: 'bold'}}> Reader</span> class and adds

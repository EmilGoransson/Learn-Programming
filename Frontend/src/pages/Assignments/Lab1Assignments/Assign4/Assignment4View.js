...
function Lab1a4View(props) {
  return (
    <div className="Lab-page max-w-3xl mx-auto text-left py-8 px-4 text-sans text-[#CECECE] ">
      ...
      <p className="mb-4">
      To use the <code>Scanner</code> class, you must first import it into your Java program. You can do this by 
      ...
      <p className="mb-4">
      To read input using Scanner, you must first create a Scanner object. You can do this by calling the Scanner 
      constructor and passing in the input source as a parameter.  For example, to read input from the keyboard, 
      ...
      <p className="mb-4">
      The Scanner class provides methods for reading different types of data, such as <code>nextInt()</code> for reading 
      integers, <code>nextDouble()</code> for reading floating-point numbers, and <code>nextLine()</code> for reading strings.
      </p>
      <h2 className="text-2xl font-bold mb-4">Summary</h2>
      <p className="mb-4">
      Overall, the <code>Scanner</code> class is a powerful tool for reading input in Java, and understanding how to use it is essential for 

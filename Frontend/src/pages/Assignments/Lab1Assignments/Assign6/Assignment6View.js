...
function Lab1a6View(props) {
  return (
    <div className="Lab-page max-w-3xl mx-auto text-left py-8 px-4 text-sans text-[#CECECE] ">
      ...
      <p className="mb-4">
      A class in Java is defined using the <code>class</code> keyword followed by the name of the class. The body of the class 
  ...
  // class body goes here
      ...
      <p className="mb-4">
      A class can have properties, which are variables that store data. Properties are declared within the class body, outside of 
  ...
  String name = "John";
      ...
      <p className="mb-4">
      A class can also have methods, which are functions that perform actions. Methods are declared within the class body, after the 
  ...
  public void printName() {
    System.out.println(name);
      ...
      <p className="mb-4">
      A class can have a constructor, which is a special method that is called when an object is created. The constructor initializes 
  ...
  public MyClass(int x) {
    this.x = x;
      ...
      their visibility to other classes. Public members can be accessed by any class, private members can only be accessed by the 
      ...
      <h2 className="text-2xl font-bold mb-4">Summary</h2>
        <p>    
          Classes are an important part of object-oriented programming in Java, and understanding how to create and use classes 

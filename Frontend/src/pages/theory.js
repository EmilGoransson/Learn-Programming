  ...
  return (
    <div className="Theory">
      ...
      <p className="mb-4">
        ...
        might have to do the same thing over and over again instead of rewriting
        the code at every part of the code section you can write the code once
        in a method and then just call it. Imagine instead of having one person
        doing all the jobs that need to be done for something you can divide up
        the jobs so that someone can always do one job, much more effective
        right. Therefore, if you master methods you can create much more optimal
        code.
      </p>
      ...
      <pre className="rounded-md p-4 mb-4">
